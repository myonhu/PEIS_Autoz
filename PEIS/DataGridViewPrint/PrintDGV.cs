...
namespace PEIS.DataGridViewPrint
{
    class PrintDGV
    {
        ...
        public static void Print_DataGridView(DataGridView dgv1,string title)
        {
            ...
            try
            {
                ...
                PrintOptions dlg = new PrintOptions(AvailableColumns, title);
                ...
                while (RowPos <= dgv.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        if (NewPage)
                        {
                            ...
                            //        Brushes.Black, e.MarginBounds.Left+200, e.MarginBounds.Top -
                            //e.Graphics.MeasureString(PrintTitle, new Font(dgv.Font,
                            //        FontStyle.Bold), e.MarginBounds.Width).Height - 13);

                            e.Graphics.DrawString(PrintTitle, new Font(dgv.Font.FontFamily,22),
                            ...
                            e.Graphics.DrawString(s, new Font(dgv.Font.FontFamily, 12),
                                    Brushes.Black, e.MarginBounds.Left + (e.MarginBounds.Width -
                                    e.Graphics.MeasureString(s, new Font(dgv.Font,
                                    FontStyle.Bold), e.MarginBounds.Width).Width), e.MarginBounds.Top -
                                    e.Graphics.MeasureString(PrintTitle, new Font(new Font(dgv.Font,
                    ...
                    int RowsPerPage)
        {
            ...
            double zys = Math.Ceiling((double)(cnt / RowsPerPage));
            if (zys <= 0) zys = 1;
