...
namespace SourceGrid
{
	...
	public class RangeRegion : ICollection<Range>
	{
		...
		//N.B. Il codice di questa classe ?scritto in maniera tale da non avere mai sovrapposizioni.
		// Quindi una cella potr?essere contenuta in un solo range.
		...
		private bool InternalRemove(RangeRegion pRange)
		{
			...
			if (pRange.IsEmpty())
				return true; //il range non ?presente
			pRange.m_bValidated = true;
