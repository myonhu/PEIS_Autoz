...
namespace PEIS.xtgg
{
    public class Printer
    {
        ...
        public static void AddCustomPaperSize(string PrinterName, string PaperName, decimal WidthInMm, decimal HeightInMm)
        {
            if (PlatformID.Win32NT == Environment.OSVersion.Platform)
            {
                ...
                if (OpenPrinter(PrinterName, out hPrinter, ref defaults))
                {
                    try
                    {
                        ...
                        formInfo.Size.width = (int)(WidthInMm * 1000);
                        formInfo.Size.height = (int)(HeightInMm * 1000);
            ...
            else
            {
                ...
                if (hDC != IntPtr.Zero)
                {
                    ...
                    pDevMode.dmPaperWidth = (short)(WidthInMm * 1000);
                    pDevMode.dmPaperLength = (short)(HeightInMm * 1000);
